...
enums = (
    ...
    ("din8_target", ("din8_dst_ir210", "din8_dst_ir543", "din8_dst_ir543_no_xy", "din8_dst_a", "din8_dst_b", "din8_dst_h", "din8_dst_l","din8_dst_r", "din8_dst_i" )),
    ("din8_source", ("din8_src_dout8", "din8_src_ram", "din8_src_alu8", "din8_src_io")),
    ("dout8_sel", ("dout8_sel_ir543", "dout8_sel_ir210_no_xy", "dout8_sel_ir210", 
                   "dout8_sel_rega", "dout8_sel_regb", "dout8_sel_regc", "dout8_sel_reg_h", "dout8_sel_reg_l",
    ...
    ("alu8_source", ("alu8_src_ram", "alu8_src_dout8","alu8_src_tmp_lo", "alu8_src_io", "alu8_src_ram_addr")),
    ("alu8_op", ("alu8_op_ip543", "alu8_op_ip543b", "alu8_op_ip543_cbrot", "alu8_op_inc", "alu8_op_dec", "alu8_op_bit", 
                 "alu8_op_res", "alu8_op_set", "alu8_op_in", "alu8_op_neg", "alu8_op_rrd_1", "alu8_op_rrd_2", "alu8_op_rld_1", "alu8_op_rld_2", "alu8_op_bit_fixup")),
